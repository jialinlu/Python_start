...
\bookseries{计算机基础系列}
\author{复旦CAD实验室}
\pressname{306出版社} %出版社名称
\presslogo{figures/fudan.png} %出版社徽标
\makecover
\tableofcontents
\newpage

\chapter{Python语言入门}
\input{chapter_python/section1}
\input{chapter_python/section2}
\input{chapter_python/section3}
\input{chapter_python/section4}
\input{chapter_python/section5}
